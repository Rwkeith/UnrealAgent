...
{
	// Prevent this voice input from being garbage collected while the widget is alive.
	...
	{
		AddToRoot();
		UE_LOG(LogTemp, Log, TEXT("UnrealGPT: VoiceInput added to root to prevent GC"));
	}
